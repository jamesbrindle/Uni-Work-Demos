...
public class vieworders extends common {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Previous Orders</title>");
        firstBit(request, response); //html print, replica minimisation method located in 'common' 
        out.println(
                "<td height='60' colspan='4'><font size='5' face='Arial, Helvetica, sans-serif'>Previous Orders</font></td>");
        ...
        if (validated) { //if user is logged in...
            ...
            try { //select books previously ordered for a particualr user
                ...
                while (rs1.next()) { //show prevoulsy ordered books  
                    rowCount++;     	
                    out.println("<tr>");
