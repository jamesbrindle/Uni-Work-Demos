//this servlet searches the database for previous orders of a user
...
public class viewuserhistory extends common {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>User History - Teachers Area</title>");
        firstBit(request, response); //html print, replica minimisation method located in 'common' 
        out.println(
                "<td height='60' colspan='4'><font size='5' face='Arial, Helvetica, sans-serif'>User History - Teachers Area</font></td>");
        ...
        if (validated) { //if teacher is logged in...
            ...
            try { //select books previously ordered for a particualr user
                String selectSQL = "select * from books,orders,users where orders.username=users.username && orders.bookid=books.bookid && orders.username='"
                        + username + "'";
                ...
                out.println("<br><font face='Arial, Helvetica, sans-serif'>User: "+greeting+"'s Order History:<br><br>");
            ...
            if (rowCount == 1) { //if rowcount is equivalent to 1, then no rows have returned (i.e. no items found)
                ...
                out.println("<p>user has no previous orders</p>");
                out.println("</font>");
            } else {}
            
            out.println("<font face='Arial, Helvetica, sans-serif'>");
            out.println("<p><a href='teachersarea'>Go to teacher area</a></p>"); 
            out.println("<p><a href='usersearch'>Go back to user search</a></font></p>");
